...
class Query():
    ...
    def __init__(self, query_graph, neg_samples, hard_neg_samples, neg_sample_max=100, keep_graph=False):
        ...
        # print("############################################999")
        # print(type(query_graph))
        # print(query_graph)
        # print()
        # print(type(neg_samples))
        # print(neg_samples)
        # print()
        # print(type(hard_neg_samples))
        # print(hard_neg_samples)
        # print()
        # print(neg_sample_max)
        # print(keep_graph)
        # print("############################################999")
...
class Graph():
    ...
    def __init__(self, features, feature_dims, relations, adj_lists):
        ...
        # print(features)
        # print("feature_dims: ", type(feature_dims))
        # print(feature_dims)
        # print("relations: ", type(relations))
